...
const server=await createTerminalServer({port:5187,token:process.env.TERMINAL_TOKEN??'local-demo-token',allowedOrigins:['http://127.0.0.1:5186','http://localhost:5186'],hostOptions:{cwd:process.cwd()}});
